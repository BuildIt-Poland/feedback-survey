...
REACT_APP_API_URL=https://kxnm8p2g1a.execute-api.us-east-1.amazonaws.com/dev npm run build
...
aws s3 sync build/ "s3://feedback-survey-web" --acl public-read --delete
